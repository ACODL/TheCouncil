    ...
    return (
        <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-6">
            ...
            <button
                onClick={signIn}
                disabled={busy}
                className="flex items-center justify-center gap-3 rounded border border-faint px-4 py-2.5 text-sm transition hover:border-ink disabled:opacity-40"
            >
            ...
            {error && <p className="mt-3 text-xs text-mid">{error}</p>}
        </main>
    );
}